...
[Расширенные универсальные ограничения](https://github.com/)

УЛУЧШЕНИЕ СУЩЕСТВУЮЩИХ ФУНКЦИЙ:

[Поддержка == и != для кортежей](https://github.com/)

[Подключение атрибутов к резервным полям для автоматически реализуемых свойств](https://github.com/)
