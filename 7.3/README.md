...
[Расширение переменных выражений в инициализаторах](https://github.com/sharpist/C_Sharp/tree/master/7.3#Расширение-переменных-выражений-в-инициализаторах)

[Улучшенный отбор потенциальных перегрузок](https://github.com/sharpist/C_Sharp/tree/master/7.3#Улучшенный-отбор-потенциальных-перегрузок)

НОВЫЕ ПАРАМЕТРЫ КОМПИЛЯТОРА:

[Параметр компилятора publicsign](https://github.com/sharpist/C_Sharp/tree/master/7.3#Параметр-компилятора-publicsign)

[Параметр компилятора pathmap](https://github.com/sharpist/C_Sharp/tree/master/7.3#Параметр-компилятора-pathmap)
