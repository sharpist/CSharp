...
[Обратные вызовы (callback) из неуправляемого кода](https://github.com/)
...
Типы, которые требуют копирования при выводе из функции, классы массивов и
класс StringBuilder являются – ```in/out```.
