...
свойствам и событиям только из используемых интерфейсов объекта, задействуя
вспомогательные COM-интерфейсы, реализуемые COM-объектом и не предоставляя
доступа к ним клиенту .NET.
