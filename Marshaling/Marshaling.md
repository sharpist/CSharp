...
представления типа COM. Для связанных типов взаимодействия среда CLR
поддерживает эквивалентность типов между такими различными представлениями.
...
эквивалентные, если они являются оболочками для идентичного COM-типа и, даже,
если сборки взаимодействия, с которыми они связаны, скомпилированы независимо.
...
взаимодействия COM. Типы COM эквивалентны, если имеющийся GUID совпадает.
