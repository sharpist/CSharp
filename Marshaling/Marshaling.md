...
* [Эквивалентность типов](https://github.com/)
...
Связывание со сборками взаимодействия COM устанавливается по умолчанию. Для
отключения в обозревателе решений перейти в свойства ссылки и выставить
