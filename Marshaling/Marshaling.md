...
непосредственно в приложение (управляемые сборки).
...
представления типа COM. Среда CLR поддерживает эквивалентность типов между
тамими различными представлениями.
...
неким типом взаимодействия COM, тогда такие типы будут значиться эквивалентными,
если они являются оболочками для идентичного типа COM.
