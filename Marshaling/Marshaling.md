...
```
В результате генерируется файл библиотеки типов COM (.tlb), который можно
регистрировать и использовать в приложениях COM.
...
* сборки PIA необходимо регистрировать в GAC, требование справедливо даже для
разработчиков, создающих небольшие дополнения к компоненту COM.
